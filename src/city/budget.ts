...
/** Current generated render-plan ceilings. Real packages must be re-measured. */
export const CITY_SCENE_RENDER_BUDGET: Readonly<Record<CityBudgetClass, Readonly<CityRenderBudget>>> = Object.freeze({
...
export function evaluateCityRenderBudget(
  ...
  const limits = CITY_SCENE_RENDER_BUDGET[budgetClass];
...
export const CITY_SANDBOX_RENDER_BUDGET = CITY_SCENE_RENDER_BUDGET;
