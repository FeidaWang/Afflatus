...
export const ROUTE_SEO = Object.freeze({
  ...
  portfolio: {
    social: {
      background: 'assets/og-backgrounds/home.jpg',
      eyebrow: { en: 'AFFLATUS · PORTFOLIO', zh: 'AFFLATUS · 作品集' },
      ...
      alt: {
        en: 'Project Afflatus portfolio and captain log in deep space',
        zh: '深空中的 Project Afflatus 作品集与舰长日志',
      },
...
export const SITE_MANIFEST = Object.freeze([
  {
    ...
    metadata: {
      title: 'AFFLATUS — Systems for uncertain worlds',
      description: "AFFLATUS is Feida Wang's personal command system for capital, software, market intelligence and long-range research.",
      canonical: 'https://feida.au/',
      ogTitle: 'AFFLATUS · Systems for uncertain worlds',
      ogDescription: 'Capital, software and intelligence for long horizons.',
      ogImage: ROUTE_SEO.main.social.images.en,
    },
    locales: {
      en: {
        title: 'AFFLATUS — Systems for uncertain worlds',
        description: "Feida Wang's personal command system for capital, software, market intelligence and long-range research.",
      },
      zh: {
        title: 'AFFLATUS — 为不确定的世界构建系统',
        description: '王飞达用于资本、软件、市场情报与长期研究的个人指挥系统。',
      },
    },
  },
  {
    ...
    capabilities: ['canvas', 'webgl', 'combat'],
    metadata: {
      title: 'Portfolio · Project Afflatus',
      description: "Bruce's privacy-first FY2025–26 capital flight recorder, software field notes, original writing and data-driven experiments.",
      canonical: 'https://feida.au/portfolio.html',
      ogTitle: 'Project Afflatus · Portfolio',
      ogDescription: 'A deep-space captain log for capital, software, original writing and data-driven experiments.',
