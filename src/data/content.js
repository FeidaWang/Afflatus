...
export const PICKS_ZH = [
  {tk:'NVDA', name:'NVIDIA', pct:16, layer:'算力核心', role:'全栈 AI 工厂主反应堆', catalyst:'Rubin、网络与软件把单颗加速器扩展为整座 AI 工厂。', risk:'出口限制、客户自研芯片与极高市场预期。', why:'加速器、网络与软件组成最完整的 AI 工厂平台；数据中心需求仍在高速扩张。它是舰队的<em>主反应堆</em>，但出口限制与高预期决定了仓位不能失控。'},
  {tk:'AVGO', name:'Broadcom', pct:14, layer:'定制硅 / 网络', role:'超大规模集群神经总线', catalyst:'定制 AI 加速器和以太网交换共同承接客户自研潮。', risk:'客户集中、订单节奏与估值压缩。', why:'定制 AI 加速器与以太网交换同时受益于超大规模客户自研潮，软件现金流又提供缓冲，是集群内部不可替代的<em>神经总线</em>。'},
  {tk:'MSFT', name:'Microsoft', pct:12, layer:'云 / 分发', role:'企业 AI 商业化舱门', catalyst:'Azure 供给扩张与 Copilot 向现有工作流持续渗透。', risk:'资本开支回报周期拉长与云端竞争。', why:'Azure、Copilot 与企业分发把模型能力直接送进工作流；当前约束更像供给而非需求。资本开支沉重，但它拥有最清晰的<em>商业化舱门</em>。'},
  {tk:'TSM', name:'TSMC', pct:12, layer:'先进制造', role:'先进制程与封装制造咽喉', catalyst:'领先制程、CoWoS 与先进封装产能继续扩张。', risk:'台海地缘风险与半导体资本周期。', why:'先进制程与先进封装仍是整条 AI 供应链最难绕开的制造咽喉。技术领先提供护城河，地缘风险则要求保留<em>安全距离</em>。'},
  {tk:'AMZN', name:'Amazon', pct:11, layer:'云 / 自研芯片', role:'算力分发母港', catalyst:'AWS、Trainium 与 Bedrock 智能体形成软硬一体的成本曲线。', risk:'基础设施投入、利润率波动与云份额竞争。', why:'AWS 同时掌握云需求、Trainium 芯片经济性与 Bedrock 智能体入口；既卖算力又改造算力成本，是舰队的<em>分发母港</em>。'},
  {tk:'GOOGL', name:'Alphabet', pct:10, layer:'模型 / 分发', role:'端到端智能平台', catalyst:'Gemini、TPU 与 Google Cloud 在搜索之外形成第二增长回路。', risk:'监管压力与生成式答案重塑搜索经济。', why:'搜索现金引擎、Gemini、TPU 与 Google Cloud 构成少数真正端到端的 AI 平台。监管与搜索迁移是风险，也是估值没有完全失重的原因。'},
  {tk:'MU', name:'Micron Technology', pct:8, layer:'高带宽内存', role:'带宽瓶颈高能补给舰', catalyst:'HBM4 放量与受纪律约束的先进内存供给。', risk:'内存价格周期、扩产与客户认证节奏。', why:'HBM4 量产让它直接站在带宽瓶颈上；供给纪律可把技术升级转成定价权。但内存周期极端，故只把它作为<em>高能补给舰</em>。'},
  {tk:'ANET', name:'Arista Networks', pct:7, layer:'AI 网络', role:'以太网数据动脉', catalyst:'800G 向 1.6T 升级，AI 集群东西向流量继续爆发。', risk:'超大客户集中与集群建设节奏变化。', why:'AI 集群向 800G 与 1.6T 以太网演进，Arista 用软件与交换平台承接东西向流量爆发；客户集中和建设周期限制仓位。'},
  {tk:'VRT', name:'Vertiv', pct:6, layer:'电力 / 散热', role:'数据中心生命维持系统', catalyst:'高密度机架推动供电、液冷与热管理升级。', risk:'高预期、项目执行和数据中心建设延迟。', why:'电力、液冷与热管理已从幕后设备变成 AI 数据中心的物理瓶颈。订单能见度强，但市场预期同样很高，定位为<em>生命维持系统</em>。'},
  {tk:'AMD', name:'Advanced Micro Devices', pct:4, layer:'替代算力', role:'第二计算航线', catalyst:'MI450、Helios 与 EPYC 打开平台级替代空间。', risk:'软件生态、路线图兑现与竞争性定价。', why:'MI450、Helios 与 EPYC 提供最可信的第二套加速计算路线；软件生态和执行仍需验证，因此把它控制为一张<em>非对称期权</em>。'}
];

export const PICKS_EN = [
  {tk:'NVDA', name:'NVIDIA', pct:16, layer:'COMPUTE CORE', role:'Full-stack AI-factory reactor', catalyst:'Rubin, networking and software expand the accelerator into an entire AI factory.', risk:'Export controls, customer silicon and exceptionally high expectations.', why:'The most complete AI-factory platform across accelerators, networking and software, with data-center demand still expanding fast. The fleet\'s <em>main reactor</em>—sized below dominance because export controls and expectations remain real risks.'},
  {tk:'AVGO', name:'Broadcom', pct:14, layer:'CUSTOM SILICON / NETWORK', role:'Hyperscale cluster neural bus', catalyst:'Custom AI accelerators and Ethernet both ride hyperscaler self-silicon.', risk:'Customer concentration, order timing and multiple compression.', why:'Custom AI accelerators and Ethernet both ride hyperscaler self-silicon, while software cash flow adds ballast. It remains the cluster\'s essential <em>neural bus</em>.'},
  {tk:'MSFT', name:'Microsoft', pct:12, layer:'CLOUD / DISTRIBUTION', role:'Enterprise AI monetization airlock', catalyst:'Azure capacity and Copilot keep moving into established enterprise workflows.', risk:'Longer capex payback and intensifying cloud competition.', why:'Azure, Copilot and enterprise distribution move model capability directly into workflows; supply looks tighter than demand. Capex is heavy, but it owns the clearest <em>monetization airlock</em>.'},
  {tk:'TSM', name:'TSMC', pct:12, layer:'ADVANCED MANUFACTURING', role:'Process and packaging choke point', catalyst:'Leading-edge nodes, CoWoS and advanced-packaging capacity keep expanding.', risk:'Taiwan geopolitics and the semiconductor capital cycle.', why:'Leading-edge process and advanced packaging remain the hardest manufacturing choke point to route around. Technical leadership is the moat; geopolitics sets the <em>safety distance</em>.'},
  {tk:'AMZN', name:'Amazon', pct:11, layer:'CLOUD / CUSTOM SILICON', role:'Compute distribution harbor', catalyst:'AWS, Trainium and Bedrock agents connect demand with silicon economics.', risk:'Infrastructure intensity, margin volatility and cloud-share competition.', why:'AWS owns cloud demand, Trainium silicon economics and the Bedrock agent gateway. It sells compute while redesigning its cost curve—the fleet\'s <em>distribution harbor</em>.'},
  {tk:'GOOGL', name:'Alphabet', pct:10, layer:'MODEL / DISTRIBUTION', role:'End-to-end intelligence platform', catalyst:'Gemini, TPUs and Google Cloud create a second loop beyond Search.', risk:'Regulation and generative answers reshaping search economics.', why:'Search cash flow, Gemini, TPUs and Google Cloud form one of very few end-to-end AI platforms. Regulation and search migration are risks—and why expectations have not fully escaped gravity.'},
  {tk:'MU', name:'Micron Technology', pct:8, layer:'HIGH-BANDWIDTH MEMORY', role:'Bandwidth-bottleneck supply ship', catalyst:'HBM4 volume and disciplined advanced-memory supply.', risk:'Memory pricing cycles, expansion and qualification timing.', why:'HBM4 volume shipments put Micron directly on the bandwidth bottleneck, where supply discipline can become pricing power. Memory is violently cyclical, so it stays a <em>high-energy supply ship</em>.'},
  {tk:'ANET', name:'Arista Networks', pct:7, layer:'AI NETWORKING', role:'Ethernet data artery', catalyst:'The 800G-to-1.6T transition compounds east-west AI traffic.', risk:'Hyperscaler concentration and changing cluster build schedules.', why:'As AI fabrics move through 800G into 1.6T Ethernet, Arista\'s software and switching platform carries the east-west traffic surge. Customer concentration and build cycles cap the weight.'},
  {tk:'VRT', name:'Vertiv', pct:6, layer:'POWER / COOLING', role:'Datacenter life-support system', catalyst:'Dense racks force upgrades in power delivery, liquid cooling and thermal control.', risk:'Elevated expectations, project execution and datacenter delays.', why:'Power, liquid cooling and thermal management have become physical AI-datacenter bottlenecks. Visibility is strong, expectations are high: the portfolio\'s <em>life-support system</em>.'},
  {tk:'AMD', name:'Advanced Micro Devices', pct:4, layer:'ALTERNATIVE COMPUTE', role:'Second compute trajectory', catalyst:'MI450, Helios and EPYC open a platform-scale alternative.', risk:'Software ecosystem, roadmap execution and competitive pricing.', why:'MI450, Helios and EPYC offer the most credible second route in accelerated computing. Software and execution still need proof, so it remains an <em>asymmetric option</em>.'}
];
