...
export const COPY = {
  zh:{
    ...
    s2desc:'这份隐私优先的报告只保留模型上界、周期年化与持仓时长；单笔结果和全部底层账户数值保持私密。',
  ...
  en:{
    ...
    s2desc:'This privacy-first report retains only modeled upper bounds, cycle annualization and holding duration. Position-level outcomes and all underlying account values remain private.',
