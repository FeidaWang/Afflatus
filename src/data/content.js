...
export const COPY = {
  zh:{
    ...
    coord:'坐标 · FY25/26 资本黑匣子',scrollHint:'打开 FY25/26 飞行记录',
    ...
    s2desc:'三层遥测只回答三个有效问题：已结清周期的资金速度、相对基准的推力倍数，以及五条已完成航线的持仓时间结构。',
  ...
  en:{
    ...
    coord:'coordinates · FY25/26 capital black box',scrollHint:'open FY25/26 flight record',
    ...
    s2desc:'Three telemetry layers answer three useful questions: closed-cycle capital velocity, thrust relative to supplied benchmarks, and the holding-time geometry of five completed routes.',
