...
0. **N1**《玉熙宫词》第一部 30 章落地执行（2026-07-07 立项，**当前最高优先级**）——**v8 脚本已定稿（2026-07-14）**于 `prompts/yuxi-150-script.md`：站主裁决改为 **30 章 × 均章 ~1.33 万字 ≈ 40 万字**（十节 × 3 章），无限流强情节定调（智斗 boss 局/多反转/配角高光/团队合作/打怪升级），游戏化系统上线（副本规则书/香火积分结算/道具卡/灵魂契约同契），穿越机制改十次往返（每节入幕出幕+现实间隔写实，衔接自检清单）；《大明王朝1566》全二册 PDF 已全文提取入库（楔子+40章逐章定位，脚本 §7.6 原著实读清单），感情线重定调（结尾才生暧昧、互不戳破）。已发 120 章为底稿素材库。执行方式：说「写第 N 章」，一章一批整章替换。
