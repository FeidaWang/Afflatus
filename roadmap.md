...
0. **N1**《玉熙宫词》第一部 500 章落地执行（2026-07-07 立项，**当前最高优先级**）——**v7 脚本已定稿（2026-07-13）**于 `prompts/yuxi-150-script.md`：站主裁决第一部扩为 **500 章（十节×5幕×10章）、总量维持 ~30 万字、均章 ~600 字微章体裁、从头全量重写**（已发 120 章降级为底稿）；分幕总表与锚点章号见脚本 §4.0，批次=一幕 10 章顺写、整节替换发布（书签作废为已接受代价）。v6 资产（幕宇宙论/史料弹药库/心理档案/历练技）全部继承。**节一+节二共 100 章（新 #1–100，46717字）已写完并整节替换发布**至 `public/novels/yuxi-gongci.json`（旧底稿順移为新 #101-155 暂充占位）；**节三幕一（新 #101-110，3283字）已写，草稿暂存**（节三未满5幕，暂不整节替换）。2026-07-13 单日新增约4.4万字。执行方式：说「写节三幕二」继续。
...
| Novels | `serial.html` | 小说连载书架：《万界种春》（无限流·种田）＋《长夜请柬》（无限流·悬疑推理）＋《玉熙宫词》（无限流·明穿权谋，第一部500章脚本v7·全量重写中（旧120章为底稿）），书架切换 | 复古未来主义 · 铜/青（纯中文，护眼阅读，含夜间/豆沙绿/米黄三种阅读模式、自动翻页、书签、瀑布流、章节速览） | **Labs** |
