...
0. **N1**《玉熙宫词》150 章全脚本落地执行（2026-07-07 立项，**当前最高优先级**）——**v6 脚本已定稿（2026-07-13）**于 `prompts/yuxi-150-script.md`：节一至节八共 **120 章已发布**（实测 `public/novels/yuxi-gongci.json`，v4/v5 的「已发 32 章」表述已过时），v6 立项「扩至 30 万字」——先新写节九/节十（121–150，2000+/章）闭合骨架，再逐节回头把已发 120 章扩写至均章 ~2000 字（历史细节+人物心理，弹药见脚本 §7/§8，施工规范与逻辑守恒清单 §9）；新增幕宇宙论（§6，第一副本=大明1566，第二副本后室/三体双候选伏笔规范）与男主历练技体系。执行方式：按脚本 §3 批次表，说「写节N」或「扩节N」即开工。
...
| Novels | `serial.html` | 小说连载书架：《万界种春》（无限流·种田）＋《长夜请柬》（无限流·悬疑推理）＋《玉熙宫词》（无限流·明穿权谋，150章脚本v6·已发120章·扩写至30万字进行中），书架切换 | 复古未来主义 · 铜/青（纯中文，护眼阅读，含夜间/豆沙绿/米黄三种阅读模式、自动翻页、书签、瀑布流、章节速览） | **Labs** |
