...
6. **V21** 观星台「治愈系」大改版 + 运势娱乐功能矩阵（参照测测 App 立项，2026-07-06）——**Phase 0–6 全部完成 ✅（2026-07-06，详见 `RELEASE_NOTES.md`，视觉整体待真人浏览器验收）**。仅存后续决策项：行星星座（引星历库 vs 手写系数的取舍）、紫微辅星/四化，简要指针见 §7.8。**注意 C5 约束：任何 Phase 若要开新页，必须先做 Astro 评估。**
