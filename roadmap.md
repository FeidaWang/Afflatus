...
4. **V21** 观星台「治愈系」大改版 + 运势娱乐功能矩阵（参照测测 App 立项，2026-07-06）——**Phase 0 ✅ + Phase 1 ✅ 已完成（2026-07-06，详见 `RELEASE_NOTES.md`，视觉待真人浏览器验收）**。后续：Phase 2 大运流年 → 3 星宿 → 4 十六型人格测试 → 5 西方星盘 → 6 紫微斗数，完整规格与分期见 **§7.8**。**注意 C5 约束：任何 Phase 若要开新页，必须先做 Astro 评估。**
...
| Novels | `serial.html` | 无限流小说连载书架：《万界种春》（种田）＋《长夜请柬》（悬疑推理）＋《玉熙宫词》（明穿·28章全文完），书架切换 | 复古未来主义 · 铜/青（纯中文，护眼阅读，含夜间/豆沙绿/米黄三种阅读模式、自动翻页、书签、瀑布流、章节速览） | **Labs** |
...
| 2 | 大运流年+生肖流年+性别字段 | M | 起运岁数/大运序列与专业排盘同盘全对；分享码向后兼容 |
| 3 | lunar.js+星宿（本命/值日/双人） | M | 农历转换抽查 ≥20 个已知日期；星宿与公开宿曜表对照 |
| 4 | 十六型人格速测（先过 C5 评估） | M | 计分确定性 vitest；商标免责声明在页 |
| 5 | 星盘（个人+双人相位） | L | 行星黄经与公开星历表误差 ≤1°；相位表 vitest |
| 6 | 紫微斗数 | XL | 真实命盘反推验证（同 V20.8 方法论） |
