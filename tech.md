...
0. **N1《玉熙宫词》第一部明幕 40 章**（2026-08-09 已完成 v12.3 全量重构）：唯一脚本口径在 `prompts/yuxi-150-script.md`；站点正文已更新至 #40《烛尽》，40 章均为 1.3–1.5 万字，总量控制在 55–60 万字。明幕结尾固定为双方都知晓且知道对方知晓、但未点穿，关系状态不因换幕清零；#41 自 1969 年红岸入口承接，后续工作转入星幕 #41–120。
